...
cask "rberga06-font-meslo-lgs-nf" do
    ...
    url "https://#{ENV['HOMEBREW_GITHUB_API_TOKEN']}@github.com/RBerga06/files-homebrew-tap/raw/master/Fonts/MesloLGS%20NF.zip" #, :using => GitHubPrivateRepositoryReleaseDownloadStrategy
